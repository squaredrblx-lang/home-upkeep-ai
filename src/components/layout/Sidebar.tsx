...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[260px] h-screen bg-white border-r border-gray-200 flex flex-col fixed left-0 top-0 z-30">
      {/* Logo */}
      <div className="px-5 py-4 border-b border-gray-100">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-gray-900">Home Upkeep AI</span>
        </Link>
      </div>
